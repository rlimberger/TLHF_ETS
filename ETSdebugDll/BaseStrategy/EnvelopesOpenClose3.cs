...
namespace ModulSolution.Robots
{
    ...
    public class EnvelopesOpenClose3 : Script
    {
    ...
    "Величина на которую должен пробиться полоса. Данная величина умножается на шаг цены.");
            ...
            for (var bar = IndexBar; bar < CandleCount - 1; bar++)
            {
                if (Envelopes.param.LinesIndicators[0].LineParam[0].Value < bar)
                {
                    ...
                    if (//ShortPos.Count >= 0 && //_dir != "Long" &&
                        Candles.OpenSeries[bar] < priceUp[bar] &&
                    ...
                    if (//LongPos.Count >= 0 && //_dir != "Short" &&
                        Candles.OpenSeries[bar] > priceDown[bar] &&
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.DateChange = new DateTime(2020, 08, 19);
            DesParamStratetgy.Author = "1EX";

            DesParamStratetgy.Description = "";
            DesParamStratetgy.Change = "";
            DesParamStratetgy.TypeStrategy = EnumStrategy.Trend;
            DesParamStratetgy.LinkFullDescription = "https://etstrading.ru/roboti#rec356480874";
            DesParamStratetgy.NameStrategy = "EnvelopesClose3";
