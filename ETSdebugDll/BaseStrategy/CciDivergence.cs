...
{
    public class CciDivergence : Script
    {

        public CreateIndicator Cci = new CreateIndicator(EnumIndicators.Rsi, 1, "");
        ...
        public override void Execute()
        {
            for (var bar = IndexBar; bar < CandleCount - 1; bar++)
            {
                ...
                SetDivergence(bar, Cci.param.LinesIndicators[0].PriceSeries);
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.DateChange = new DateTime(2020, 04, 15);
            DesParamStratetgy.Author = "1EX";

            DesParamStratetgy.Description = "";
            DesParamStratetgy.Change = "";
            DesParamStratetgy.TypeStrategy = EnumStrategy.Flat;
            DesParamStratetgy.LinkFullDescription = "https://etstrading.ru/tpost/c0ulv53g71-robot-ccidivergence";
            DesParamStratetgy.NameStrategy = "CciDivergence";
