...
namespace ModulSolution.Robots
{
    ...
    public class BbOpenClose : Script
    {
    ...
    "Величина на которую должен пробиться полоса. Данная величина умножается на шаг цены.");
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.LinkFullDescription = "https://etstrading.ru/tpost/40jdyjpcn1-polosi-bollindzhera";
            DesParamStratetgy.NameStrategy = "BpOpenClose";
