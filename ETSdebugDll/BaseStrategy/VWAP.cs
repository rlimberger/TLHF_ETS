...
namespace ModulSolution.Robots
{
    ...
    public class VWAP : Script
    {
        public CreateIndicator FastMa = new CreateIndicator(EnumIndicators.Vwap, 0, "Быстрая");
        public CreateIndicator SlowMa = new CreateIndicator(EnumIndicators.Vwap, 0, "");
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.DateRelease = new DateTime(2022, 11, 11);
            DesParamStratetgy.DateChange = new DateTime(2022, 11, 11);
            ...
            DesParamStratetgy.NameStrategy = "VWAP";
