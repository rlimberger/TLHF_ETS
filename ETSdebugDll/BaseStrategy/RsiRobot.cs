...
namespace ModulSolution.Robots
{
    ...
    public class RsiRobot : Script
    {
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.DateChange = new DateTime(2020, 04, 01);
            DesParamStratetgy.Author = "1EX";

            DesParamStratetgy.Description = "";
            DesParamStratetgy.Change = "";
            DesParamStratetgy.TypeStrategy = EnumStrategy.Trend;
            DesParamStratetgy.LinkFullDescription = "https://etstrading.ru/tpost/j0mucreof1-rsirobot-robot-po-indikatoru-rsi";
            DesParamStratetgy.NameStrategy = "RsiRobot";
