...
{
    public class RsiDivergence : Script
    {
        ...
        public override void Execute()
        {
            for (var bar = IndexBar; bar < CandleCount - 1; bar++)
            {
                ...
                SetDivergence(bar, Rsi.param.LinesIndicators[0].PriceSeries);
        ...
        public override void GetAttributesStratetgy()
        {
            ...
            DesParamStratetgy.DateRelease = new DateTime(2019, 10, 29);
            ...
            DesParamStratetgy.LinkFullDescription = "https://etstrading.ru/tpost/khceb34xg1-robot-rsidivergence";
            DesParamStratetgy.NameStrategy = "RsiDivergence";
